...
namespace DevRegTest.domainVMApp
{
                ...
                where TApplication : Application, ISingleInstanceApp
    {
        ...
        private static void CreateRemoteService(string channelName)
        {
            ...
            props["authorizedGroup"] = Tools.GetNTNameForSID("S-1-1-0"); // S-1-1-0 = "Everyone" group (called "tout le monde" on french computers, "..." on spanish ones, ...)
        ...
        /// </param>
        private static bool SignalFirstInstance(string channelName, IList<string> args)
        {
        ...
        private static bool ActivateFirstInstance(IList<string> args)
        {
        ...
        private class IPCRemoteService : MarshalByRefObject
        {
            ...
            public bool InvokeFirstInstance(IList<string> args)
            {
                if (Application.Current != null)
                {
                    // Do an synchronous call to ActivateFirstInstance function
                    var result = Application.Current.Dispatcher.Invoke(DispatcherPriority.Normal, new DispatcherOperationCallback(SingleInstance<TApplication>.ActivateFirstInstanceCallback), args);
                    if (result is bool)
                        return ((bool)result);
                    else
                        return false;
